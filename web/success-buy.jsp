...
<html>
    ...
    <body>
        ...
        <div class="content-container">
            ...
            <ul>
                <li><span class="quantity">1x </span>item 1 <span class="price">(Price here)</span></li>
                <li><span class="quantity">1x </span>item 2 <span class="price">(Price here)</span></li>
            </ul>
            <h3>The total amount is: <span class="total">$0.00</span></h3>
            <h2>Thank you for purchasing our UST Merchandise, we hope to see you again!</h2>
            <h2>To return to the homepage, Please <a href="">click here.</a></h2>
        </div>
    </body>
</html>